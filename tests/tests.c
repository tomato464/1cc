...
int main(){
	...
	assert ( 10, ({int x; x = 10;int i; for(i = 0; i < 10; i = i + 1)x = x + 1;  i;}) ,"({int x; x = 10;int i; for(i = 0; i < 10; i = i + 1)x = x + 1;  i;})");
	assert ( 15, add5(1, 2, 3, 4, 5) ,"add5(1, 2, 3, 4, 5)");
	assert ( 3, ret3() ,"ret3()");
	assert ( 50, ({ int b; b = 50; b;}) ,"({ int b; b = 50; b;})" );
	assert ( 18, ({ 3*4 + 2*3;}) , "({ 3*4 + 2*3;})");
	assert( 0 , 0 ,"0");
	assert (3, ({ int x = 3; *&x; }),"({ int x = 3; *&x; })");
	...
	assert (5 , ({ int x; int *y; y = &x; *y = 5; x;}) ,"({ int x; int *y; y = &x; *y = 5; x;})");
	assert (43 , add2(40, 3) ,"add2(40, 3)");
	assert (55 , fib(9) ,"fib(9)");
	assert (20 , sub2(30, 10) ,"sub2(30, 10)");
	assert (14 , ({ int a; a = 4; int b; b = 10; a + b;}) ,"({ int a; a = 4; int b; b = 10; a + b;})");
	assert (42 , 42 ,"42");
	assert (21 , 5+20-4 ,"5+20-4");
	assert (21 , 5 + 20 - 4 ,"5 + 20 - 4");
	assert (2 ,  3*4-10, "3*4-10");
	assert (2 , 3 * 4 - 10 ,"3 * 4 - 10");
	assert (72 , 3* (4+2)*4 , "3* (4+2)*4");
	...
	assert (0 , 5 < 5 ,"5 < 5");
	assert (0 , 6 < 2 ,"6 < 2");
	assert (1 , 43 <= 53 ,"43 <= 53");
	assert (1 , 42 <= 42 ,"42 <= 42");
	assert (0 , 53 <= 21 ,"53 <= 21");
	assert (14 , ({ int foo; foo = 4; int two; two = 10;  foo + two;}) ,"({ int foo; foo = 4; int two; two = 10;  foo + two;})");
	assert (43 , ({ int x; x = 11;int y; y = 32; x + y;}) ,"({ int x; x = 11;int y; y = 32; x + y;})");
	assert (3 , ({ int x;if(0)x = 2; else x = 3; x;}) ,"({ int x; if(0)x = 2; else x = 3; x;})");
	assert (2 , ({ int x;if(1)x = 2; else x = 3; x;}) ,"({ int x; if(1)x = 2; else x = 3; x;})");
	assert (43 , ({ int x; x = 10; if(x == 5)x = 20; else x = 43; x;}) ,"({ int x; x = 10; if(x == 5)x = 20; else x = 43; x;})");
	assert (30 , ({ int x; x = 5;int y; y = 2; if(x == 5)if(y == 2) x = 30; x;}) ,"({ int x; x = 5;int y; y = 2; if(x == 5)if(y == 2) x = 30; x;})");
	assert (10 , ({ int i; i = 0; while(i < 10)i = i + 1;  i;}) ,"({ int i; i = 0; while(i < 10)i = i + 1;  i;})");
	assert (20 , ({ int x; int i; x = 10;for(i = 0; i < 10; i = i + 1)x = x + 1; x;}) ,"({ int x; int i; x = 10;for(i = 0; i < 10; i = i + 1)x = x + 1; x;})");
	assert (10 , ({ int i; i = 0;for(;i < 10;i = i + 1)i = i + 1; i;}) ,"({ int i; i = 0;for(;i < 10;i = i + 1)i = i + 1; i;})");
	assert (10 , ({ int i; i = 0;for(;i < 10;)i = i + 1; i;}) ,"({ int i; i = 0;for(;i < 10;)i = i + 1; i;})");
	printf("OK\n");
	return 0;
}
